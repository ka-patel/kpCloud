...
:
:strScriptVer = "2.6b - Rob Dunn @ http://community.spiceworks.com"
:'~~[author]~~
:'Rob Dunn
...
findstr /B ":" "%~sf0" >update.txt
sed -e "s+^:++g" update.txt >update.vbs
%ComSpec% /c %SystemRoot%\System32\cscript.exe //nologo update.vbs action:install mode:verbose restart:1 force:1
